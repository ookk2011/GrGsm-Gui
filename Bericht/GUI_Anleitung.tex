...
\mywidthpicture{GUI_Window}{Standard Fenster GUI}{fig:fig1}{0.0}{\textwidth}
...
\mywidthpicture{GUI_Done}{Abgeschlossener Scan}{fig:fig2}{0.0}{\textwidth}
...
\mywidthpicture{GUI_Textinfo}{Info des BCCH}{fig:fig3}{0.0}{\textwidth}

\mywidthpicture{GUI_Tooltip}{Mouseover Tooltip}{fig:fig4}{0.0}{\textwidth}
...
\mywidthpicture{GUI_aufgeklappt}{GUI Ansicht angeklickt}{fig:fig5}{0.0}{\textwidth}

\mywidthpicture{GUI_childinfo}{Infos der Childnodes}{fig:fig}{0.0}{\textwidth}
