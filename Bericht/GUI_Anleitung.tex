...
Zuerst jedoch noch ein paar Erklärungen zu dem Aufbau unseres modifizierten grgsm_scanners.
...
\mydennis{GUI_Window}{Standard Fenster GUI}{fig1}{0.0}{0.9\textwidth}
...
\mydennis{GUI_Done}{Abgeschlossener Scan}{fig2}{0.0}{0.9\textwidth}
...
\mydennis{GUI_Textinfo}{Info des BCCH}{fig3}{0.0}{0.9\textwidth}

\mydennis{GUI_Tooltip}{Mouseover Tooltip}{fig4}{0.0}{0.9\textwidth}
